...
source("~/Library/CloudStorage/OneDrive-WilfridLaurierUniversity/ontarioelection2025/R_Scripts/1_read_in_news.R")

# 2. Spacing fix on the raw text
df$text <- gsub("([a-z])\\.([A-Z])", "\\1. \\2", df$text)
